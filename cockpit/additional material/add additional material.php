...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="../../style/cockpit/additional%20material/add additional material.css"/>
	...
	<main>
		...
		<b> Add additional material </b> 
		<br />
		<div id="add">
			<form action="" method="POST" enctype="multipart/form-data">
				<div id="additionalFile">
		...
		<?php
			try {
				...
				AdditionalMaterialService::uploadFile();
			} 
