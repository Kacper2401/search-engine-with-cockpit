...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="../../style/cockpit/additional material/delete additional material.css"/>
	...
	<main>
		<div id="name">
			<b>Delete additional material</b>
			<br />
			To delete a material, click its name. 
			<br />
		</div>
        <div id="sideMenu">
            <div id="chooseError">
		...
		<?php
			try {
				...
				AdditionalMaterialService::deleteAdditionalMaterial();
				AdditionalMaterialService::displayAdditionalMaterialDelete();
			} 
