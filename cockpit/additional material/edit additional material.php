...
<html lang="en">
	...
	<main>
		...
		<?php
			try {
				...
				AdditionalMaterialService::updateAdditionalMaterial();
				AdditionalMaterialService::displayAdditionalMaterialToEdit();
			} 
	...
	<style>
		<?php
			include '../../style/cockpit/additional material/edit additional material.css';
		?>
	</style>
	<footer>
		<hr/>
