...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="../../style/cockpit/cockpit/add cockpit.css"/>
		...
		<div id="add">
			<form method="POST" action="">
				<div id="cockpitName">
					Cockpit name
					<br />
					<input type="text" name="cockpitName">
				</div>
				<div id="cockpitShortcut">
					Cockpit shortcut
					<br />
					<input type="text" name="cockpitShortcut">
				</div>
				<br /><br /><br />
