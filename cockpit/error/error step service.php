...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="../style/error step service.css"/>
	...
	<main>
		<?php
			try {
				...
				ErrorService::setErrorNumber();
				ErrorService::createErrorCockpit();
			} 
	...
	<style>
		<?php
			include "../../style/cockpit/error/error step service.css";
