...
<html lang="en">
	...
	<main>
		<?php
			try {
				...
				DecisionTreeService::deleteDecisionTree();
				DecisionTreeService::createDecisionTreeCockpit();
			} 
	...
	<style>
		<?php
			include "../../../style/cockpit/error/decision tree/decision tree service.css";
